...
// 대미지 계산식 (str * 계수) + (int * 계수) + (타입 * 몹타입) 후, mp소모하고 , 상태이상 있을시 독립시
 ...
 // todo 스킬 대미지 설정 제대로 넣기
    private  SkillDB() {
        // 검사공용
        playerskillList.add(new Skill("찌르기", "참격", "대검으로 찌릅니다. \n STR 10% | INT 5%",1,"전사", 20, 10, 5, 0));
        playerskillList.add(new Skill("막기", "방어", "검으로 막습니다. DEX가 높을 시, 더 많은 수치의 대미지를 방어합니다. \n STR 20% | DEX 20% ", 1,"전사",20, 20, 0, 20));
        playerskillList.add(new Skill("크게 휘두르기", "참격", "대검으로 크게 휘두릅니다. \n STR 15% | INT 5%",5,"전사",20, 15, 5, 0));
        playerskillList.add(new Skill("십자베기", "참격", "대검을 십자로 휘둘러 참격을 입힙니다. \n STR 25% | INT 5%",9,"전사", 20, 25, 5, 0));
        playerskillList.add(new Skill("홀리 슬래시", "참격", "빛을 검에 담아 베어가릅니다. \n STR 30% | INT 5%", 10,"전사",20, 30, 5,0));
        playerskillList.add(new Skill("홀리 레이", "마법", "빛으로 된 레이저를 발사합니다. \n STR 10% | INT 40%", 14,"전사",20, 10, 40,0));
        playerskillList.add(new Skill("HP힐", "버프", "체력을 회복합니다. \n STR 20% | DEX 40%", 18,"전사",20, 20, 0, 40));
        playerskillList.add(new Skill("2회전 베기", "참격", "검을 두 번 연속으로 휘두릅니다. \n STR 45% | INT 10%",20, "", 20, 45, 10, 0));
        playerskillList.add(new Skill("별모양 베기", "참격", "별 모양으로 베어가릅니다. \n STR 60% | INT 10%", 27,"전사",20, 60, 10,0));
        ...
        playerskillList.add(new Skill("마나 실드", "마법", "마나를 몸 주위에 펼쳐 적의 공격을 방어합니다. \n STR 10% | INT 5%", 1,"마법사", 0,20, 20, 30));
        ...
        playerskillList.add(new Skill("블레이즈 소드", "마법", "불로 된 검을 만들어 참격을 입힙니다. \n STR 10% | INT 5%", 14,"마법사", 0,20, 20, 30));
